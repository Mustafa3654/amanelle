...
class AccountForm { public static function configure(Schema $schema): Schema { return $schema->components([
    ...
    Select::make('type')->options(['cash' => 'Cash box', 'bank' => 'Bank', 'purchases' => 'Purchases', 'sales' => 'Sales', 'payable' => 'Accounts payable', 'receivable' => 'Accounts receivable', 'expense' => 'Expense', 'income' => 'Income', 'other' => 'Other'])->required(),
